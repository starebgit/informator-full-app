...
import { eventNameColors, eventsColors } from "../../../theme/ChartColors";
...
function UnitStaffCard({ unit, foremans, ...props }) {
    ...
    const detailAbsence = Object.keys(reducedAbsence)
        ...
        .map((key) => {
            //const detailAbsence = Object.keys(reducedAbsence).map(key => {
    ...
    return (
        <Card>
            ...
            <div style={{ padding: "0rem 2rem", fontSize: "14px" }}>
                <Table size='sm'>
                    <thead>
                        <tr>
                            <th></th>
